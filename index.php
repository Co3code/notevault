...
<head>
    ...
    <style>
        ...
        .profile-edit-btn:hover { color: #667eea; }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header" style="text-align:center; padding: 1.5rem 1rem 1rem;">
            <div class="sidebar-brand" style="justify-content:center; margin-bottom:0.75rem;">
                <i class="fas fa-book-open"></i> NoteVault
            </div>
        ...
        <div class="sidebar-footer">
            <small class="text-muted" style="font-size:0.72rem;">NoteVault &copy; <?php echo date('Y'); ?></small>
            <a href="auth/logout.php" class="logout-icon-btn">
                ...
                <form action="user/update_profile.php" method="POST">
                    <div class="modal-body">
                        ...
                        <?php if (isset($_GET['profile_error'])): ?>
                            <div class="alert alert-danger py-2"><?php echo htmlspecialchars($_GET['profile_error']); ?></div>
                        <?php endif; ?>
                        <div class="mb-3">
                        ...
                        <hr>
                        <p class="text-muted" style="font-size:0.8rem;">Leave password fields blank to keep current password</p>
                        <div class="mb-3">
